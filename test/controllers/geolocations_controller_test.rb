...
class GeolocationsControllerTest < ActionController::TestCase
  ...
  test "should create geolocation" do
    assert_difference('Geolocation.count') do
      post :create, geolocation: { address: @geolocation.address, latitude: @geolocation.latitude, longitude: @geolocation.longitude }
    end
  ...
  test "should update geolocation" do
    patch :update, id: @geolocation, geolocation: { address: @geolocation.address, latitude: @geolocation.latitude, longitude: @geolocation.longitude }
    assert_redirected_to geolocation_path(assigns(:geolocation))
  end
